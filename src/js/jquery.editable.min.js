...
(function($, window) {
  "use strict";
  var $win = $(window), $textArea = false, $currentlyEdited = false,
      EVENT_ATTR = "data-edit-event", IS_EDITING_ATTR = "data-is-editing",
      EMPTY_ATTR = "data-is-empty", DBL_TAP_EVENT = "dbltap",
      SUPPORTS_TOUCH = "ontouchend" in window,
      TINYMCE_INSTALLED =
          "tinyMCE" in window && typeof window.tinyMCE.init == "function",
      oldjQueryIs = $.fn.is, lastTap = 0, tapper = function() {
        ...
        } else if (e.data.toggleFontSize && e.metaKey &&
        ...
        if (navigator.userAgent.match(/webkit/i) !== null) {
          textareaStyle =
              document.defaultView.getComputedStyle($el.get(0), "").cssText
        }
            ...
            ed.onInit.add(function(editor, evt) {
              ...
              var editorBlur = function() {
                ...
                if (typeof opts.callback == "function") {
                  opts.callback({
                    content : newText == defaultText || !hasPressedKey
                                  ? false
                                  : newText,
                    fontSize : false,
                    $el : $el
              ...
              setTimeout(function() { $win.bind("click", editorBlur) }, 500);
              $textArea = $("<textarea></textarea>");
              $textArea.bind("blur", editorBlur);
              editorWindow.onkeydown = function() { hasPressedKey = true };
              editorWindow.focus()
            })
          };
              ...
              .blur(function() {
                ...
                if (typeof opts.callback == "function") {
                  opts.callback({
                    ...
                    fontSize : newFontSize == defaultFontSize ? false
                                                              : newFontSize,
                    $el : $el
                  })
                }
